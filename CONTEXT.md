...
- 当前 `v2.16.1`（学分公示增强：概览最高/最低分 + 零扣分续航榜 + 班委端确认，已推送）
- 上一版 `v2.16.0`（学分公示模块首发）
...
```bash
cd /d/a/chee777/class-manager
for f in _v290 _v2100 _v2110 _v2113 _v2120 _v2130 _v2140 _v2150 _v2160 _sync _xss; do node ${f}_test.js; done
```
