...
- 当前 `v2.15.1`（学分一致性 + 图表 100 分制口径热修，已推送）
...
```bash
cd /d/a/chee777/class-manager
for f in _v290 _v2100 _v2110 _v2113 _v2120 _v2130 _v2140 _v2150 _sync _xss; do node ${f}_test.js; done
```
