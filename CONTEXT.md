...
- 当前 `v2.17.0`（可编辑原因目录 + 多级菜单逐层化 + 班委操作留痕/扣分开关，已推送）
...
```bash
cd /d/a/chee777/class-manager
for f in _v290 _v2100 _v2110 _v2113 _v2120 _v2130 _v2140 _v2150 _v2160 _v2170 _sync _xss; do node ${f}_test.js; done
```
