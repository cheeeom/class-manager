...
t('版本标记统一 v2.18.13', () => {
  has(html, '<div class="login-version">v2.19.3</div>', '登录页版本');
  has(html, '<div class="sidebar-footer">v2.19.3 · 班主任工作台</div>', '侧栏版本');
  has(html, '🏷️ v2.19.3</span>', '设置页徽标');
});
t('sw.js CACHE_NAME 已升版', () => {
  has(fs.readFileSync('sw.js', 'utf8'), "CACHE_NAME = 'class-manager-v2.19.3'", 'sw 缓存名');
});
t('速览新增修复条目', () => {
  has(html, '（v2.19.3）', '近版更新速览');
});
