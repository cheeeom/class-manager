...
## ✨ v2.4.1 新特性（2026-08-15）
### 📐 v2.4.1 无障碍补全（2026-08-15）
- **aria-label 补全**：详情面板关闭按钮、PWA 安装提示关闭按钮（icon-only 按钮可读性）
- **小字号收敛**：10px→11px（排序图标/座位号/座位操作/成绩对比标签），11px→12px（状态徽章/统计标签/登录版本号/待办元信息等 13 处），表格紧凑场景保留 12px
