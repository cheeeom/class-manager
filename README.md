...
## ✨ v2.7.0 新特性（2026-08-29）——「纸墨·新中式」全站美术重塑

- 🎨 **全新视觉语言**：宣纸暖白底 × 浓墨文字 × 朱砂红主色，标题改用宋体族，告别通用后台脸
- 🖋 **登录页重做**：玄墨面板 + 窗棂线性纹 + 印章式 logo + 竖排校训 + 旋转「印」落款 + 菱形密码点
- 📊 **图表改五彩颜料色**：胭脂/琥珀/青花蓝/石绿/青莲，亮暗两套模式均清晰可读
- 🌙 **玄墨暗色模式**：暖墨底色替换冷板岩灰，与纸墨主题统一（并修复了 v2.6.0 起侧栏不变暗的问题）
- 📱 PWA 主题色同步为朱砂红（manifest.json）
