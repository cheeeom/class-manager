/* v2.18.7 回归测试：云同步推送失败「报错人话化 + 退避重试」。
...
console.log('\n=== 版本 ===');
t('版本标记统一 v2.18.7', () => {
  has(html, '<div class="login-version">v2.18.7</div>', '登录页');
  has(html, '<div class="sidebar-footer">v2.18.7 · 班主任工作台</div>', '侧栏');
  has(html, '🏷️ v2.18.7</span>', '设置徽标');
  has(fs.readFileSync('sw.js', 'utf8'), "CACHE_NAME = 'class-manager-v2.18.7'", 'SW');
});
t('近版更新速览含新条', () => {
